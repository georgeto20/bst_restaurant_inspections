...
public class RestaurantInfo {
	 ...
	 */
	public static void sortTest(String inputFileName) throws ParseException { 
		...
		final int NUM_OF_RECORDS_PER_SET = 1500;
		final int NUM_OF_RECORDS_TOTAL = NUM_OF_TEST_DATA_SETS * NUM_OF_RECORDS_PER_SET;
		final int NUM_OF_WARMUP_RECORDS_PER_SET = 10;
